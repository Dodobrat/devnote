...
const SIDEBAR_WIDTH_MOBILE = "min(calc(100vw - 1rem), 22rem)";
      ...
      <div
        ...
        className={cn(
          ...
          side === "left"
            ? cn(
                "left-safe-offset-0",
                "group-data-[collapsible=offcanvas]:left-safe-offset-[calc(var(--sidebar-width)*-1)]",
              )
            : cn(
                "right-safe-offset-0",
                "group-data-[collapsible=offcanvas]:right-safe-offset-[calc(var(--sidebar-width)*-1)]",
              ),
