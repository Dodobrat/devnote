...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <Dialog.Content className="md:top-safe-offset-[20vh] top-safe-offset-4 translate-y-0 overflow-hidden p-0">
        <Command
...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "text-foreground [&_[cmdk-group-heading]]:text-muted-foreground overflow-hidden p-2 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-sm [&_[cmdk-group-heading]]:font-medium",
        className,
      )}
      {...props}
    />
...
function CommandShortcutSnippet({
  ...
  return (
    <CommandShortcut
      className={cn("rounded border px-1 text-sm", className)}
      {...props}
    />
  );
}
