      ...
      <div className="grid gap-10">
        ...
        >
          <div className="grid w-full divide-y">
            ...
            <a
              ...
              className="text-primary py-2 underline underline-offset-4"
            >
        ...
        <Page.Section title="FAQ" description="Frequently asked questions">
          ...
          <FAQItem question="Can I restore a note?">
            No, once a note is deleted it cannot be restored. Please be careful
            when deleting notes.
          </FAQItem>
          ...
          <FAQItem question="Can I use it without internet?">
            Yes. Once you open the app for the first time, it is cached and can
  ...
  return (
    <div className="flex flex-col gap-1 py-3">
      <div className="flex gap-2 font-bold">
        <span className="text-muted-foreground w-6 shrink-0">Q:</span>{" "}
        <p>{question}</p>
      </div>
      <div className="flex gap-2">
        <span className="text-muted-foreground w-6 shrink-0 font-bold">A:</span>{" "}
        <p>{children}</p>
      </div>
    </div>
  );
